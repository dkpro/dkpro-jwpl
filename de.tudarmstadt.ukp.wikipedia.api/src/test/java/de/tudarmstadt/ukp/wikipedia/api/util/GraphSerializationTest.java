...
public class GraphSerializationTest {
     ...
     */
    @Test
    public void initializeWikipedia() throws WikiInitializationException{
     ...
     */
    @Test
    public void testGraphSerialization() throws WikiApiException {
        

        CategoryGraph sourceGraph = CategoryGraphManager.getCategoryGraph(wiki);
        testGraph(sourceGraph.getGraph());
        sourceGraph.saveGraph(serializationFileName);

        CategoryGraph loadedGraph = new CategoryGraph(wiki, new File(serializationFileName));
