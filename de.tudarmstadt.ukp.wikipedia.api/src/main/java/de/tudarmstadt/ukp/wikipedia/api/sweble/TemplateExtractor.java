...
/**
 * A visitor that extracts templates from an article AST.
 * 
 * @author Oliver Ferschke
 */
public class TemplateExtractor extends AstVisitor
{
	 ...
	 */
	public TemplateExtractor(SimpleWikiConfiguration config)
	{
		this.config = config;
	}
