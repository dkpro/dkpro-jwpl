...
public class DefaultTimeMachineEnvironmentFactoryTest {
  ...
  @BeforeEach
  public void setUp() {
    factory = DefaultTimeMachineEnvironmentFactory.getInstance();
  }
  ...
  public void testGetDumpTableStream() {
    ...
    assertInstanceOf(XMLDumpTableInputStream.class, dtInputStream);
  }
}
