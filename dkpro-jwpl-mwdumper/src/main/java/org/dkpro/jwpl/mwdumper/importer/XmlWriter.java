...
/**
 * Quickie little class for sending properly encoded, prettily indented XML output to a stream.
 * There is no namespace support, so prefixes and xmlns attributes must be managed manually.
 */
public class XmlWriter
{
    ...
    /**
     * Write an empty element, such as &lt;el/&gt;, on a standalone line. Takes an optional
    ...
    /**
     * Write an element open tag, such as &lt;el/&gt;, on a standalone line. Takes an optional
     * dictionary of attributes.
     *
     * @throws IOException
     *             Thrown if IO errors occurred.
    ...
    /**
     * Write an element close tag, such as &lt;el/&gt;, on a standalone line. If indent=False is
     * passed, indentation will not be added.
     *
     * @throws IOException
     *             Thrown if IO errors occurred.
     */
     ...
     * standalone line. If the text is empty, an empty element will be output as &lt;el/&gt;. Takes
     * an optional list of tuples with attribute names and values.
     *
     * @throws IOException
     *             Thrown if IO errors occurred.
     */
