...
public class RevisionPair {
	...
	/**
	 * If the base template of this RevisionPair is an inline template,
	 * this method uses the text around the template to create the diff.
	 *
	 ...
	 * Usually corresponding to a RevisionPair.
	 *
	 * @author Oliver Ferschke
	 *
	 */
