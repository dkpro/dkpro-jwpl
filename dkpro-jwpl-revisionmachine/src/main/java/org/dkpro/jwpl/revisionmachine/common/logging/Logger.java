...
public class Logger
{
     ...
     */
    public Logger(final LoggerType type, final String consumerName) throws LoggingException
    {
        ...
        try {
            ...
            throw ErrorFactory
                    .createLoggingException(ErrorKeys.LOGGING_LOGGER_INITIALIZISATION_FAILED, e);
        }
    }
    ...
    {
        try {
            Logger errors = LoggingFactory.getLogger(LoggingFactory.NAME_ERROR_LOGGER);
     ...
     *            Exception
     */
    public void logException(final Level level, final String message, final Exception e)
    {
    ...
    /**
     * The occurred error or exception with the related log level and message will be logged by this
     * method.
     *
     * @param level
     *            log level
     ...
     *            Throwable
     */
    private synchronized void logThrowable(final Level level, final String message,
            final Throwable t)
    {
