 ...
 * <p>
 * This panel contains all components for setting configuration parameters related to the debug
 * purposes.
 */
    ...
    extends AbstractPanel
{
    ...
    {
        statsOutputCheckBox = new JCheckBox("Activate Article Information Output");
    ...
    {
        Object o = config.getConfigParameter(ConfigurationKeys.VERIFICATION_DIFF);
        if (o != null) {
        ...
        o = config.getConfigParameter(ConfigurationKeys.MODE_STATISTICAL_OUTPUT);
        if (o != null) {
    ...
    public void toXML(final StringBuilder builder, final ConfigVerification errors)
    {
        ...
        if (verifyDiff || verifyEncoding || statsOutput || debugOutput) {
            ...
            if (verifyDiff) {
                builder.append("\t\t<verification_diff>" + verifyDiff + "</verification_diff>\r\n");
            }
            ...
            if (statsOutput) {
                builder.append(
                        "\t\t<statistical_output>" + statsOutput + "</statistical_output>\r\n");
            }
