 ...
 * Besides that, it does the same as WikipediaXMLReader.
 */
    ...
    extends WikipediaXMLReader
{
     ...
     *
     * @return FALSE if the article was not accepted by the articleNameChecker TRUE if no name
     *         checker was used, or if the articleNameChecker accepted the ArticleName
     * @throws IOException
