 ...
 */
package org.dkpro.jwpl.revisionmachine.common.logging.messages;
...
public class DiffToolLogMessages {
   ...
   * @param articleConsumer number of active article consumers
   * @param diffConsumer    number of active diff consumers
   * @param sqlConsumer     number of active sql consumers
   * @param archiveState    state of the arcive producer
   * @param articleState    state of the article producer
   * @param diffState       state of the diff producer
   */
   ...
   *
   * @param logger  reference to the logger
   * @param endTime time since start
   */
