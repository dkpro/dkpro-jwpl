...
public class ChronoStorageBlock {
   ...
   *
   * @param counterNext next counter block
   */
   ...
   *
   * @param counterPrev previous counter block
   */
   ...
   *
   * @param indexNext next index block
   */
   ...
   *
   * @param indexPrev previous counter block
   */
   ...
   *
   * @param cfr           Reference to the chrono full revision
   * @param revisionIndex Index of this revision
