...
public class RevisionDecoder {
   ...
   * returns the Diff.
   *
   * @param blockSize_C length of a C block
   * @param blockSize_S length of a S block
   * @param blockSize_E length of a E block
   * @param blockSize_B length of a B block
   * @param blockSize_L length of a L block
   * @return Diff
   * @throws UnsupportedEncodingException if the character encoding is unsupported
   * @throws DecodingException            if the decoding failed
   */
   ...
   *
   * @param input  Reference to an input stream
   * @param binary flag, whether the data is binary or not
   ...
   *
   * @param input base 64 encoded diff
