    ...
    extends AbstractPanel
{
    ...
    public void applyConfig(final ConfigSettings config)
    {
        ...
        Object o = config.getConfigParameter(ConfigurationKeys.LOGGING_PATH_DIFFTOOL);
        if (o != null) {
        ...
        o = config.getConfigParameter(ConfigurationKeys.LOGGING_LOGLEVEL_DIFFTOOL);
        if (o != null) {
    ...
    public void toXML(final StringBuilder builder, final ConfigVerification errors)
    {
        ...
        if (!pathDiffTool.endsWith(File.separator) && pathDiffTool.contains(File.separator)) {
            pathDiffTool += File.separator;
        }

        builder.append("\t\t<root_folder>\"").append(pathDiffTool).append("\"</root_folder>\r\n");
        builder.append("\t\t<diff_tool>\r\n");
        builder.append("\t\t\t<level>").append(diffToolLogLevelComboBox.getSelectedItem())
                .append("</level>\r\n");
        builder.append("\t\t</diff_tool>\r\n");
        builder.append("\t</logging>\r\n");
    }
