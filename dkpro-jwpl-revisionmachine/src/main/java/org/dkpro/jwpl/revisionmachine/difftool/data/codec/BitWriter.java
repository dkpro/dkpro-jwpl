...
public class BitWriter {
   ...
   *
   * @param val an integer representing a full byte
   * @throws EncodingException if the value is out range
   */
   ...
   *
   * @param bit 0 or 1
   * @throws EncodingException if the input is neither 0 nor 1.
   */
   ...
   * @throws EncodingException if the length of the input is more than 31 bits.
   */
