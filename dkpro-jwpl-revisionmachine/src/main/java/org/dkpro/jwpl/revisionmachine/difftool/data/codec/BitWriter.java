...
public class BitWriter
{
     ...
     */
    private void write(final int val) throws EncodingException
    {
     ...
     */
    public void writeBit(final int bit) throws EncodingException
    {
     ...
     */
    public void writeValue(final int length, final int value) throws EncodingException
    {
        if (length > 31) {
            throw ErrorFactory.createEncodingException(
                    ErrorKeys.DIFFTOOL_ENCODING_VALUE_OUT_OF_RANGE,
    ...
    /**
     * Writes the byte array to the buffer. The currently used buffer will be filled with zero bits
     * before it is written in front of the byte-array.
     *
     * @param bText
     *            byte array
     * @throws EncodingException
     ...
     */
    public void write(final byte[] bText) throws EncodingException
    {
    ...
    /**
     * The currently used buffer will be filled with zero bits before it is written in the buffer.
     *
     * @throws EncodingException
     *             if the writing fails
     */
    public void writeFillBits() throws EncodingException
    {
