 ...
 * <p>
 * A clock representation describes the time (HH:MM:SS:sss) and is used for measuring the processing
 * times.
 */
public class Time
{
    ...
    /**
     * (Constructor) Creates a new time information transforming the millisecond value into a clock
     * representation.
     *
     * @param time
     *            milliseconds
