...
public final class ArticleConsumerLogMessages
{
            ...
            final long time)
    {
        ...
        logger.logMessage(Level.INFO,
                "Read article\t" + Time.toClock(time) + "\t" + article.toString());
    }
            ...
            final ArchiveDescription archive, final Exception e)
    {
        ...
        logger.logException(Level.ERROR, "Exception while accessing archive " + archive.toString(),
                e);
    }
    ...
    public static void logNoMoreArticles(final Logger logger, final ArchiveDescription archive)
    {
        ...
        logger.logMessage(Level.INFO,
                "Archive " + archive.toString() + " contains no more articles");
    }
     ...
     *            reference to the exception
     */
    public static void logReadTaskException(final Logger logger, final Task<Revision> task,
            final Exception e)
    {
     ...
     */
    public static void logStatus(final Logger logger, final ArticleReaderInterface articleReader,
            final long startTime, final long sleepingTime, final long workingTime)
    {
        ...
        message += "\tEFFICIENCY\t " + MathUtilities.percentPlus(workingTime, sleepingTime)
     ...
     *            reference to the exception
     */
    public static void logTaskReaderException(final Logger logger, final ArticleReaderException e)
    {
