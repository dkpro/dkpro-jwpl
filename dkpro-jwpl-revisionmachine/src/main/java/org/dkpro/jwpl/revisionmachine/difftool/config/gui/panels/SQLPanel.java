 ...
 * <p>
 * This panel contains all components for setting configuration parameters related to the database
 * output.
 */
    ...
    extends AbstractPanel
{
    ...
    private void createSQLFields()
    {
        ...
        enableSQLDatabaseConnection = new JCheckBox("Activate Database Output");
    ...
    {
        enableZipEncodingCheckBox.setSelected(controller.isZipCompressionEnabled());
    }
