...
public final class ErrorFactory
{
     ...
     */
    public static TimeoutException createTimeoutException(final ErrorKeys errorId,
     ...
     */
    public static SQLConsumerException createSQLConsumerException(final ErrorKeys errorId,
            final Exception e)
    {
