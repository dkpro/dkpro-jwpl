    ...
    implements Comparable<DiffBlock>
{
    ...
    /**
     * Flag, indicating the sorting order TRUE sorting after the start position of revision A FALSE
     * sorting after the start position of revision B
     */
     ...
     *            sorting order flag
     */
    public DiffBlock(final int id, final int revAStart, final int revAEnd, final int revBStart,
            final int revBEnd, final boolean ab)
    {
        this.id = id;
