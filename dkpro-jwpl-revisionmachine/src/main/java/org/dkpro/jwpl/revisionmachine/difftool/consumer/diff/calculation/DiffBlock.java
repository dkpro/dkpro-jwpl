...
public class DiffBlock implements Comparable<DiffBlock> {
   ...
   * @param revAStart start position of revision A
   * @param revAEnd   end position of revision A
   * @param revBStart start position of revision B
   * @param revBEnd   end position of revision B
   * @param ab        sorting order flag
   */
