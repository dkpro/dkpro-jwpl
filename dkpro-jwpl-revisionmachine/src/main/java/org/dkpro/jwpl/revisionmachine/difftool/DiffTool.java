...
public class DiffTool {
   ...
   *
   * @param args program arguments args[0] has to be the path to the
   *             configuration file
   */
   ...
   * @throws SAXException                 if an error occurred while using the xml parser
   * @throws ParserConfigurationException if the initialization of the xml parser failed
   */
