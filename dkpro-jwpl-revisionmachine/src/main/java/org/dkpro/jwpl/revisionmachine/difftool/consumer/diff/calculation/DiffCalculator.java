    ...
    implements DiffCalculatorInterface
{
    ...
    /**
     * Configuration parameter - Flag, which indicates whether debug output is enabled or not
     */
    ...
    /**
     * Configuration parameter - Flag, which indicates whether the verification of the diff is
     * enabled or not
     */
    ...
    /**
     * Temporary variable - Used to mark used characters of the previous revision
     */
     ...
     * (non-Javadoc)
     *
     * @see de.tud.ukp.kulessa.delta.consumers.diff.calculation.DiffCalculatorInterface
                ...
                if (VERIFICATION_DIFF) {
                    ...
                    try {
                        ...
                        if (!revC.equals(revP)) {
                            ...
                            throw ErrorFactory.createDiffException(
                                    ErrorKeys.DIFFTOOL_DIFFCONSUMER_DIFF_VERIFICATION_FAILED,
                                    "Reconstruction of " + task + " failed at revision "
                                            + revisionCounter + ".");
                        }
        ...
        throws UnsupportedEncodingException
    {
        ...
        // First Block
        if (revAStartIndex != 0) {
            queueA.add(new DiffBlock(this.blockCount, 0, revAStartIndex, 0, revBStartIndex, true));
            queueB.add(new DiffBlock(this.blockCount, 0, revAStartIndex, 0, revBStartIndex, false));
            this.blockCount++;
        }
            ...
            final char[] revB, final int index)
    {
        ...
        queueA.add(new DiffBlock(this.blockCount, longestMatch_start,
                longestMatch_start + longestMatch_size, index, index + longestMatch_size, true));
        queueB.add(new DiffBlock(this.blockCount, longestMatch_start,
                longestMatch_start + longestMatch_size, index, index + longestMatch_size, false));
