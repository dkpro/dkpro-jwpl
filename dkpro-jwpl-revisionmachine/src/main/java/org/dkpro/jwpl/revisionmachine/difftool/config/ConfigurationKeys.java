...
public enum ConfigurationKeys
{
     ...
     * <p>
     * A full revision is generated if the result of the revisionCounter of the revision modulo
     * COUNTER_FULL_REVISION is 0.
     * <p>
     * Recommendation / Default: Currenty a value of 1000 is used.
     * <p>
     * Example: COUNTER_FULL_REVISION = 100
     * <p>
     * FullRevisions are all revisions with a revisionCounter % 100 == 0 0, 100, 200, 300, 400, ...
     */
    COUNTER_FULL_REVISION,

    /**
     * Type: Integer Range: &gt; 1 Used by: DiffConsumers - Common Longest Substring Search
     * <p>
     * Description: This number indicates when a matching sequence between two revisions is
     * considered as sequence.
     * <p>
     * Recommendation / Default: Currently 12 Value should be greater than the encoded size of an
     * operation.
     */
     ...
     * <p>
     * Description: If you want to use 7Zip to decompress your 7z or bz2 archives set the
     * corresponding path in the config file.
     * <p>
     ...
     * <p>
     * Note that the corresponding output directory for the logger has to exist when the LogLevel is
     * not Level.OFF
     */
