...
public class IndexGenerator
{
    ...
    public static void main(String[] args)
    {
        ...
        if (args == null || args.length != 1) {
            ...
            if (props.getProperty("outputDatabase") != null
                    && Boolean.parseBoolean(props.getProperty("outputDatabase"))) {
                config.setOutputType(OutputTypes.DATABASE);
            }
            else if (props.getProperty("outputDatafile") != null
                    && Boolean.parseBoolean(props.getProperty("outputDatafile"))) {
