...
public class BitReader
{
     ...
     */
    public int readBit() throws DecodingException
    {
     ...
     * <p>
     * The maximum value of bits that could be read is 31. (Maximum value of a positive number that
     * could be stored in an integer without any conversion.)
     *
     * @param length
     *            number of bits to read
     * @return content as integer value or -1 if the end of the stream has been reached
     * @throws DecodingException
     *             if the decoding failed
     */
    public int read(final int length) throws DecodingException
    {
        ...
        for (int i = length - 1; i >= 0; i--) {
            ...
            if (v == -1) {
                if (i != length - 1) {
                    throw ErrorFactory.createDecodingException(
                            ErrorKeys.DIFFTOOL_DECODING_UNEXPECTED_END_OF_STREAM);
                }
    ...
    /**
     * Reads the next character in the input Note: The current content of the buffer will be
     * deleted. This method should only be used for reading the textual content of the diff-part.
     *
     * @return the next character in the string
     * @throws DecodingException
     *             if the decoding failed
     */
    public int readByte() throws DecodingException
    {
