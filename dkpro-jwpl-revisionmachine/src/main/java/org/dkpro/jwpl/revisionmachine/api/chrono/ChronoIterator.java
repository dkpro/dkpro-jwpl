...
public class ChronoIterator
{
     ...
     */
    public ChronoIterator(final RevisionAPIConfiguration config, final Connection connection,
            final String mapping, final String fullRevisionPKs, final String revisionCounters)
    {
        ...
        while (length < max) {
            ...
            fullRevPK = Integer.parseInt(fullRevisionPKs.substring(lengthFR, index));
            lengthFR = index + 1;
        ...
        this.chronoStorage = new ChronoStorage(config, reverseMappingStorage, firstCFR,
                fullRevStorage);
    }
     ...
     */
    public Revision next() throws Exception
    {
                ...
                if (previousRevisionCounter != -1) {
                    ...
                    if (previousRevisionCounter + 1 != result.getInt(3)) {
                        ...
                        System.err.println("Reconstruction data invalid - " + "\r\n\t" + "Expected "
                                + (previousRevisionCounter + 1) + " instead of "
                                + result.getInt(3));
                    ...
                    if (cfr.getStartRC() != result.getInt(3)) {
                        ...
                        System.err.println("Reconstruction data invalid - " + "\r\n\t" + "Expected "
                                + (cfr.getStartRC()) + " instead of " + result.getInt(3));
