...
import org.dkpro.jwpl.revisionmachine.difftool.config.gui.dialogs.ConfigDialog;
import org.dkpro.jwpl.revisionmachine.difftool.config.gui.dialogs.XMLFileChooser;
...
public class ConfigController
{
    ...
    /**
     * Configuration settings - Flag that indicates whether the 7Zip support is enabled or not
     */
    private boolean enable7Zip;

    /**
     * Configuration settings - Flag that indicates whether debug output is enabled
     */
    private boolean enableDebugOutput;

    /**
     * Configuration settings - Flag that indicates whether diff verification is enabled
     */
    private boolean enableDiffVerification;

    /**
     * Configuration settings - Flag that indicates whether encoding verification is enabled
     */
    private boolean enableEncodingVerification;

    /**
     * Configuration settings - Flag that indicates whether the database output mode is enabled
     */
    ...
    /**
     * Configuration settings - Flag that indicates whether statistical output is enabled
     */
    ...
    /**
     * Configuration settings - Flag that indicates whether multiple output files are allowed
     */
    ...
    /**
     * Loads the configuration file. The path of the file will be chosen by displaying a FileChooser
     * Dialog.
     */
    ...
    /**
     * Saves the configuration file. The path of the file will be chosen by displaying a FileChooser
     * Dialog.
     */
     ...
     *            diff verification mode
     */
    public void setEnableEncodingVerification(final boolean enableEncodingVerification)
    {
     ...
     */
    public void setOutputCompression(final OutputCompressionEnum outputCompression)
    {
