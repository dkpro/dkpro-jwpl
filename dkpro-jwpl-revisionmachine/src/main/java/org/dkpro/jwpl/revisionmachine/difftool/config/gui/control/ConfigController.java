...
public class ConfigController {
   ...
   *
   * @param index index of the archive
   */
   ...
   *
   * @param enable7Zip 7Zip support flag
   */
   ...
   *
   * @param enableDebugOutput debug output flag
   */
   ...
   *
   * @param enableDiffVerification diff verification mode
   */
   ...
   *
   * @param enableEncodingVerification diff verification mode
   */
   ...
   *
   * @param enableSQLDatabaseOutput database output flag
   */
   ...
   *
   * @param enableStatsOutput statistical output flag
   */
   ...
   *
   * @param enableZipCompression Zip-Compression flag
   */
   ...
   *
   * @param multipleOutputFiles multiple output files flag
   */
   ...
   *
   * @param outputCompression output compression mode
   */
   ...
   *
   * @param outputFileLimit maximum size of an output file
   */
   ...
   *
   * @param surrogates surrogate mode
   */
