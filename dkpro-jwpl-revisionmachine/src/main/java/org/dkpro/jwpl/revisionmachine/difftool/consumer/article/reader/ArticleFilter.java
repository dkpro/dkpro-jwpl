 ...
 * The namespaces are read in from the {@code <siteinfo>} of the Wikipedia dump. The corresponding
 * prefixes of the language version are then used by the filter to determine whether an article is
 * part of an unwanted namespace or not. <br>
 * <p>
 * If the ArticleFilter is not initialized or given an empty list of namespaces, nothing is filtered
 * at all.
 */
public class ArticleFilter
{
    ...
    /**
     * Creates a new filter that filters all pages except the namespaces provided in the
     * namespaceWhitelist
     *
     ...
     *
     * @param namespaceMap
     *            mapping of namespace ids to the corresponding article title prefixes
     */
    ...
    private void initializePrefixes()
    {
        if (namespaceMap == null) {
            // TODO use logger
            System.err.println(
                    "Cannot use whitespace filter without initializing the namespace-prefix map for the "
