 ...
 */
package org.dkpro.jwpl.revisionmachine.difftool.data.tasks.info;
...
public class ArticleInformation {
   ...
   *
   * @param diffPartCounter number of diff parts
   */
   ...
   *
   * @param encodedSize encoded size
   */
   ...
   *
   * @param encodedSQLSize size after encoding
   */
   ...
   *
   * @param enteringTime entering time
   */
   ...
   *
   * @param exitingTime exiting time
   */
   ...
   *
   * @param processingTimeDiff processing time diff
   */
   ...
   *
   * @param processingTimeRead processing time reading
   */
   ...
   *
   * @param processingTimeSQL processing time encoding
   */
