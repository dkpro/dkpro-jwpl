...
public class ArticleIndex extends AbstractIndex {
   ...
   *
   * @param currentArticleID ID of the currently used article
   * @param startTime        First date of appearance
   * @param endTime          Last date of appearance
   * @param infoList         List of revision blocks
   */
