    ...
    implements SQLEncoderInterface
{
    ...
    /**
     * Configuration parameter - Flag, which indicates whether the verification of the encoding is
     * enabled or not
     */
        ...
        throws SQLConsumerException
    {
        ...
        if (notEqual) {
            ...
            throw ErrorFactory.createSQLConsumerException(
                    ...
                    "Redecoding of " + task.getHeader().getArticleName() + " failed at revision "
