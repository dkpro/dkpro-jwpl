...
public class ChronoStorage
{
    ...
    /**
     * Map containing reference to the chrono full revisions (Mapping of revision counter and their
     * full revision blocks)
     */
     ...
     * @param mapping
     *            Mapping information (revision counter -&gt; chronological revision counter)
     * @param firstCFR
     ...
     */
    public ChronoStorage(final RevisionAPIConfiguration config, final Map<Integer, Integer> mapping,
    ...
    public Revision remove()
    {
         ...
         * block.getRevisionCounter()); if (first != null) { System.out.println("OnTop: " +
         * first.getRevisionIndex()); }
         */
        block.setDelivered(true);
    ...
    {
        return this.revisionIndex + " | " + this.storage.size() + " | " + this.size + " | "
                + totalSize;
    }
}
