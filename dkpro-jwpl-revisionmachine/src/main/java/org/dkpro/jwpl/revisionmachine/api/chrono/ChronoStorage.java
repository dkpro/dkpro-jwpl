...
public class ChronoStorage {
   ...
   * @param mapping        Mapping information (revision counter -&gt; chronological
   *                       revision counter)
   * @param firstCFR       Head of the double linked list of full revisions blocks
   * @param fullRevStorage Mapping of revision counter and their full revision blocks
   */
   ...
   *
   * @param rev reference to the revision
   */
   ...
   *
   * @param revisionIndex chronological order index
   * @return
   */
