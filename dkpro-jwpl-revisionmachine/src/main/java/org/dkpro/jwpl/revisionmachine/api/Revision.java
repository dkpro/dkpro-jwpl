...
public class Revision implements ISizeable, Comparable<Revision>, RevisionDataInterface, Serializable {
   ...
   *
   * @param revisionCounter revision counter
   * @param revisionApi     revision API
   */
   ...
   *
   * @param fullRevisionID full revision ID
   */
   ...
   *
   * @param timeStamp timestamp (wikipedia version)
   */
   ...
   *
   * @param parts a collection of DiffPart object that make up this revision
   */
   ...
   *
   * @param comment the user comment for this revision
   */
