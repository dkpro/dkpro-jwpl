 ...
 * <p>
 * The revision text is loaded upon first access (lazy loading). When serializing a Revision, the
 * revisionText will be loaded first.
 */
    ...
    implements ISizeable, Comparable<Revision>, RevisionDataInterface, Serializable
{
    ...
    /**
     * Determine whether the contributor was registered. True: contributorName= username False:
     * contributorName= IP
     */
    ...
    /**
     * A collection of DiffParts that make up this revision. This can be used to get Information
     * about the actions that have been performed to create this revision
     */
     ...
     * <p>
     * The input is expected to be the wikipedia version of the timestamp as String
     * (YYYY-MM-DDThh-mm-ssZ). T and Z will be replaced with spaces.
     *
     * @param timeStamp
