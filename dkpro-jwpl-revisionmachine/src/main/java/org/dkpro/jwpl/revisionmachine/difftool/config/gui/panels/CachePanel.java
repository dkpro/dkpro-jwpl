 ...
 * <p>
 * This panel contains all components for setting configuration parameters related to the cache.
 */
    ...
    extends AbstractPanel
{
    ...
    private void createSQLProducerSettings()
    {
        ...
        sqlProducerLimitationsLabel = new JLabel("SQLProducer Limitations (in byte)");
        ...
        maxAllowedPacketLabel.setBorder(BorderFactory.createRaisedBevelBorder());
    ...
    public void applyConfig(final ConfigSettings config)
    {
        ...
        Object o = config.getConfigParameter(ConfigurationKeys.LIMIT_TASK_SIZE_REVISIONS);
        if (o != null) {
        ...
        o = config.getConfigParameter(ConfigurationKeys.LIMIT_SQLSERVER_MAX_ALLOWED_PACKET);
        if (o != null) {
    ...
    public void toXML(final StringBuilder builder, final ConfigVerification errors)
    {
            ...
            try {
                ...
                if (tasksizeRevisions < 1000000) {
                    errors.add(new ConfigItem(ConfigItemTypes.ERROR,
                            ConfigErrorKeys.VALUE_OUT_OF_RANGE, "The value for the size of an "
                                    + "ArticleTask has to be at least " + "1000000 Byte."));
                }
            }
            catch (NumberFormatException nfe) {
                errors.add(new ConfigItem(ConfigItemTypes.ERROR, ConfigErrorKeys.ILLEGAL_INPUT,
                        "NumberFormatException for the size of" + " ArticleTasks"));
            }
        }
            ...
            try {
                ...
                if (maxAllowedPacket < 1000000) {
                    errors.add(new ConfigItem(ConfigItemTypes.WARNING,
                            ConfigErrorKeys.VALUE_OUT_OF_RANGE, "The value for SQLProducer "
                                    + "MaxAllowedPacket should be at least" + " 1000000 Byte."));
                }
            }
            catch (NumberFormatException nfe) {
                errors.add(new ConfigItem(ConfigItemTypes.ERROR, ConfigErrorKeys.ILLEGAL_INPUT,
                        "NumberFormatException for the size of" + " SQLProducer MaxAllowedPacket"));
            }
        }
        ...
        builder.append(
                "\t\t<LIMIT_TASK_SIZE_DIFFS>" + tasksizeDiffs + "</LIMIT_TASK_SIZE_DIFFS>\r\n");
        builder.append("\t\t<LIMIT_SQLSERVER_MAX_ALLOWED_PACKET>" + maxAllowedPacket
