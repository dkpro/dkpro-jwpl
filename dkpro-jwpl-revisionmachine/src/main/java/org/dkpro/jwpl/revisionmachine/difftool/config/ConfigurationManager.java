...
public class ConfigurationManager
{
     ...
     *             if the ConfigurationManager has not been created during the startup of the
     *             application.
     */
    public static ConfigurationManager getInstance() throws ConfigurationException
    {
        ...
        if (instance == null) {
            throw ErrorFactory.createConfigurationException(
                    ErrorKeys.CONFIGURATION_CONFIGURATIONMANAGER_NOT_INITIALIZED);
        }
        return instance;
    }
    ...
    /**
     * (Constructor) Creates the Configuration Manager - This constructor should only be called
     * during the startup of the DiffTool Application.
     *
     * @param config
     *            Reference to the ConfigurationSettings
     */
