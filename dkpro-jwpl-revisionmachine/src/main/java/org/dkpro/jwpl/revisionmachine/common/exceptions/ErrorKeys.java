...
public enum ErrorKeys
{
    ...
    DIFFTOOL_DIFFCONSUMER_DIFF_VERIFICATION_FAILED, DIFFTOOL_DIFFCONSUMER_SURROGATE_FOUND,

    DIFFTOOL_SQLCONSUMER_ENCODING_VERIFICATION_FAILED,
    DIFFTOOL_SQLCONSUMER_DATABASEWRITER_EXCEPTION, DIFFTOOL_SQLCONSUMER_FILEWRITER_EXCEPTION,

    DIFFTOOL_ENCODING_INVALID_VALUE, DIFFTOOL_ENCODING_VALUE_OUT_OF_RANGE,

    DIFFTOOL_DECODING_INVALID_VALUE, DIFFTOOL_DECODING_VALUE_OUT_OF_RANGE,
    DIFFTOOL_DECODING_UNEXPECTED_END_OF_STREAM,

    LOGGING_LOGGER_INITIALIZISATION_FAILED, LOGGING_LOGGINGFACTORY_NO_SUCH_LOGGER,
