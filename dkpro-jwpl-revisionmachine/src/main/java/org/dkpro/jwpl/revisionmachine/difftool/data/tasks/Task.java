...
public class Task<D>
{
     ...
     * <p>
     * The size can only be estimated if the data contains the ISizeable interface.
     *
    ...
    {
        return "[" + this.taskType.toString() + " <" + this.partCounter + ">" + "\t" + this.byteSize
                + "\t| " + this.header.getArticleId() + "\tR" + this.container.size() + "\t"
