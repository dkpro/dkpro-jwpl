    ...
    extends ParsedPageObject
{
    ...
    public enum type
    {
        EXTERNAL, INTERNAL, AUDIO, VIDEO, IMAGE, UNKNOWN
    }
    ...
    /**
     * Returns the Number of Words left and right of the Link, in the Bounds of the HomeElement of
     * this Link.
     */
    public String getContext(int wordsLeft, int wordsRight)
    {
        ...
        // retrun a string...
        return text.substring(posLeft, pos.getStart()) + text.substring(pos.getEnd(), posRight);
    }
