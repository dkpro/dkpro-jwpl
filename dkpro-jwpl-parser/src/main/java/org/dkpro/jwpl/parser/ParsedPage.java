...
public class ParsedPage
{
     ...
     * This is a shortcut for getParagraph( getFirstParagraphNr() ). It is <b>not</b> the same as
     * getParagraph( 0 ), because the physically first paragraph often contain tables etc.
     */
    ...
    // TODO What means lowest level? => TZ: I think it means "highest" semantically and "lowest" in
    // numbering (e.g. <h1>).
    ...
    {
        return superSection.nrOfParagraphs();
    }
     ...
     *
     * @param i
     *            The number of the paragraph to return.
     * @return The paragraph with number i.
     */
    public Paragraph getParagraph(int i)
    {
        return superSection.getParagraph(i);
    }
    ...
    {
        return superSection.getParagraphs();
    }
    ...
    {
        return superSection.nrOfTables();
    }
     ...
     *
     * @param i
     *            The number of the table to return.
     * @return The table with number i.
     */
    public Table getTable(int i)
    {
        return superSection.getTable(i);
    }
    ...
    {
        return superSection.nrOfNestedLists();
    }
     ...
     *
     * @param i
     *            The number of the nested list to return.
     * @return The nested list with number i.
     */
    public NestedList getNestedList(int i)
    {
        return superSection.getNestedList(i);
    }
    ...
    {
        return superSection.getNestedLists();
    }
    ...
    {
        return superSection.nrOfDefinitionLists();
    }
    ...
    {
        return superSection.getDefinitionLists();
    }
