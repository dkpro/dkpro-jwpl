...
/**
 * This is an implementation of the Content of a Section.<br>
 * For every content access function exists a setter and a remover function.<br>
 * For a description of the inherited functions of Section, take a look at the Documentation of
 * Section.
 */
    ...
    extends Section
{
    ...
    {
        if (nestedLists.size() > i)
            return nestedLists.get(i);
        else
            return null;
    }
    ...
    {
        if (definitionLists.size() > i)
            return definitionLists.get(i);
        else
            return null;
    }
    ...
    {
        return new ArrayList<>(definitionLists);
    }
    ...
    public String toString()
    {
        ...
        for (NestedList nl : nestedLists)
            result.append("\nSC_NESTED_LIST:\n" + nl);
        result.append("\nSC_DEFINITON_LISTS: " + definitionLists.size());
        for (DefinitionList dl : definitionLists)
            result.append("\nSC_DEFINITION_LIST:\n" + dl);
