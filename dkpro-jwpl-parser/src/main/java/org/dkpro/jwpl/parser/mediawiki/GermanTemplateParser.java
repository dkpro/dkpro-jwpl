...
/**
 * This is the TemplateParser for the german language, with special treatment for all the german
 * templates, like "Dieser Artikel" or "Deutschlandlastig".
 */
    ...
    implements MediaWikiTemplateParser
{
    ...
    public GermanTemplateParser(MediaWikiContentElementParser parser, List<String> deleteTemplates,
