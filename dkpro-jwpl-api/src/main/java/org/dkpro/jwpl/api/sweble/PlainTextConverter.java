...
/**
 * A visitor to convert an article AST into a plain text representation. To better understand the
 * visitor pattern as implemented by the Visitor class, please take a look at the following
 * resources:
 * <ul>
 * <li><a href="http://en.wikipedia.org/wiki/Visitor_pattern">Visitor Pattern (classic
 * pattern)</a></li>
 * <li><a href="http://www.javaworld.com/javaworld/javatips/jw-javatip98.html">the version we use
 * here</a></li>
 * </ul>
 * <p>
 ...
 * values of the <code>visit()</code> calls in a list,</li>
 * <li><code>mapInPlace(n)</code> - visit the <b>children</b> of node <code>n</code> and replace
 * each child node <code>c</code> with the return value of the call to <code>visit(c)</code>.</li>
 * </ul>
 *
    ...
    extends AstVisitor<WtNode>
{
    ...
    /**
     * Creates a new visitor that produces a plain text String representation of a parsed Wikipedia
     * article. s
     */
     ...
     * article.
     *
     * @param enumerateSection
     *            {@code True}, if sections should be enumerated in the output, {@code false}
     *            otherwise.
     */
     ...
     *
     * @param config
     *            A valid {@link WikiConfig} instance. Must not be {@code null}.
     * @param enumerateSections
     *            {@code True}, if sections should be enumerated in the output, {@code false}
     *            otherwise.
     * @param wrapCol
     *            Defines the max length of a line. longer lines will be broken.
     */
     ...
     * 'visit(de.fau.cs.osr.ptk.common.ast.AstText)' otherwise at runtime. Thus, we are ignoring it
     * for now. (see #160)
     *
     * public void visit(WtNode n) { // Fallback for all nodes that are not explicitly handled below
    ...
    public void visit(WtInternalLink link)
    {
        ...
        if (pageTitle == null || pageTitle.isEmpty()) {
            ...
            if (currentLinkTitleInCell.contains("#")) {
                // only take the first part of the string, no anchors on pages (divided by '#'
                // symbols)
     ...
     *
     * @param n
     *            A node representing a table body.
     */
     ...
     *
     * @param n
     *            A node representing a table caption.
     */
