...
public class Wikipedia implements WikiConstants {
   ...
   *
   * @param dbConfig A {@link DatabaseConfiguration} object telling the {@link Wikipedia} object
   ...
   * If the {@link Category} title start with a lowercase letter it converts it to an uppercase letter,
   * as each Wikipedia category title starts with an uppercase letter. Spaces in the title are converted to
   * underscores, as this is a convention for Wikipedia category titles.
   * <p>
