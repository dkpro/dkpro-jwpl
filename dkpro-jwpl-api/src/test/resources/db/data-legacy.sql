-- Legacy test fixture data for dkpro-jwpl-api, to be used with schema-hsqldb-legacy.sql.
-- Identical to data.sql except that the MetaData row omits the trailing 'version' value.
...
INSERT INTO MetaData VALUES (1, 'test', 'Disambiguation', 'Telecooperation', 36, 6, 2, 17);
