...
public class TextPair
{
    ...
    /**
     * Returns the patch object that contains all diffs between the beforeText and the afterText
     *
    ...
    public List<DiffRow> getDiffRows(boolean markChangesInline)
    {
        DiffRowGenerator generator = new DiffRowGenerator.Builder()
                .showInlineDiffs(markChangesInline).columnWidth(Integer.MAX_VALUE) // do not wrap
                .build();
    ...
    /**
     * Returns the deltas between beforeText and afterText as a line separated String using
     * delta.toString() For more detailed diffs, use getPatch() or getUnifiedDiffStrings()
     *
     ...
     *
     * @param difftype
     *            defines the type of diffs to include in the String
     * @return diffs as line-separated String using delta.toString()
     */
    ...
    /**
     * Returns the deltas between beforeText and afterText as a line separated String. For more
     * detailed diffs, use getPatch() or getUnifiedDiffStrings()
     *
    ...
    /**
     * Returns the unified diff between "Before" and "After" containing one sentence per String.
     * <code>contextSize</code> defines a window of lines/sentences around each change to display
     *
     * @param contextSize
     *            numer of lines/sentences around a change to display
     * @return diffs as line-separated String
     */
    public List<String> getUnifiedDiffStrings(int contextSize)
    {
        return DiffUtils.generateUnifiedDiff("Before", "After", sentenceSplit(beforeText),
                getPatch(), contextSize);
    }

    /**
     * Returns the unified diff between "Before" and "After" as a single line-separated String
     *
     * @param contextSize
     *            numer of characters around a change to display
     * @return diffs as line-separated String
     */
    ...
    /**
     * Normalizes the Strings in the TextPair. This mainly deals with whitespace-issues. Other
     * normalizations can be included.
     *
     * @param str
     * @return
     */
