...
import org.dkpro.jwpl.shade.org.sweble.wikitext.engine.EngineException;
...
public class ParseUtils
{
     ...
     */
    public static List<ExtractedSection> getSections(String text, String title, long revision)
     ...
     *            a list of template names that should be annotated in the text
     * @return list of ExtractedSections
     * @throws EngineException
     *             if the wiki page could not be compiled by the parser
     */
    public static List<ExtractedSection> getSections(String text, String title, long revision,
            List<String> templatesToMark)
        throws LinkTargetException, EngineException
    {
        return (List<ExtractedSection>) parsePage(new SectionExtractor(templatesToMark), text,
                title, revision);
    }

    /**
     * Extracts template names from Wikitext by descending into every node and looking for
     * templates. Results may contain duplicates if template appears multiple times in the article.
     *
     * @param text
     *            article text with wiki markup
     * @param title
     ...
     *             if the wiki page could not be compiled by the parser
     */
    public static List<String> getTemplateNames(String text, String title)
        throws LinkTargetException, EngineException
    {
     ...
     *             if the wiki page could not be compiled by the parser
     */
    private static Object parsePage(AstVisitor v, String text, String title, long revision)
        throws LinkTargetException, EngineException
    {
     ...
     *
     * @param str
     *            A string with template markers
     ...
     * <p>
     * Assumes hat a sentence has only ONE marker. If the sentence contains more than one template,
