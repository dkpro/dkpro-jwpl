...
public class WikipediaTemplateInfoGenerator {
  ...
  public WikipediaTemplateInfoGenerator(DatabaseConfiguration dbc, int pageBuffer, String charset, String outputPath,
                                        long maxAllowedPacket, TemplateFilter pageFilter, TemplateFilter revisionFilter,
                                        GeneratorMode mode) throws WikiApiException {
    this.dbConf = dbc;
   ...
   *
   * @param textForTemplateExtraction text for template extraction
   * @param filterToApply             filter to apply for templates
   * @param id                        id of a page/revision
   * @param mapToFill                 map to fill with data
   */
  private void fillMapWithTemplateData(String textForTemplateExtraction, TemplateFilter filterToApply, int id,
  ...
  private void processRevisions() {
    ...
    try {
      ...
      while (revisionIter.hasNext()) {
        ...
        fillMapWithTemplateData(curRevision.getRevisionText(), revisionFilter, curRevisionId, TPLNAME_TO_REVISIONIDS);
      }
   ...
   * @param templateNames template names to use
   */
   ...
   *
   * @param pageText the page to get the templates from
